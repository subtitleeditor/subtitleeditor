...
class CombineSelectedSubtitlesPlugin : public Action {
   public:
    ...
    void activate() {
        ...
        action_group->add(Gtk::Action::create("combine-selected-subtitles",
                                              _("_Combine"),
                                              _("Merge selected subtitles into one, with start being set by the start of the first selected subtitle "
                                                "and end being set by the end of the last selected subtitle")),
