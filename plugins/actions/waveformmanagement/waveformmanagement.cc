...
class WaveformManagement : public Action {
   public:
    ...
    void activate() {
        ...
        action_group->add(Gtk::Action::create("waveform/generate-from-player-file",
        ...
        // center
        action_group->add(Gtk::Action::create("waveform/center-with-selected-subtitle",
        ...
        action_group->add(Gtk::ToggleAction::create(
                              "waveform/display", _("_Waveform"), _("Show or hide the waveform in the current window"), waveform_display_state),
                          sigc::mem_fun(*this, &WaveformManagement::on_waveform_display));

        // Recent files
        Glib::RefPtr<Gtk::RecentAction> recentAction =
            Gtk::RecentAction::create("waveform/recent-files", _("_Recent Files"), _("Open a recent file"));
   ...
   protected:
    ...
    void on_select_with_player() {
        ...
        Glib::RefPtr<Gtk::ToggleAction> action =
            Glib::RefPtr<Gtk::ToggleAction>::cast_static(action_group->get_action("waveform/select-with-player"));
        if (action) {
            bool state = action->get_active();
