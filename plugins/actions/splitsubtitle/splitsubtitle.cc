   ...
   public:
    ...
    void activate() {
        ...
        action_group->add(Gtk::Action::create("split-selected-subtitles",
                                              _("_Split"),
                                              _("Split selected subtitles by lines (for each selected subtitle, as many new subtitles as it has "
                                                "lines will be created, with their total duration equaling the selected subtitle and set "
                                                "proportionately to their length while respecting the minimal gap between subtitles setting")),
