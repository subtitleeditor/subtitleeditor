...
class VideoPlayerManagement : public Action {
   public:
    ...
    void activate() {
        ...
        action_group->add(
            Gtk::Action::create("video-player/menu-skip-backwards", Gtk::Stock::MEDIA_REWIND, _("Skip _Backwards"), _("Skip Backwards")));
        ...
        action_group->add(Gtk::Action::create(
                              "video-player/seek-to-selection-end", _("_Seek To Selection End"), _("Seek to the end of the last selected subtitle")),
        ...
        action_group->add(
            Gtk::Action::create(
                "video-player/play-first-second", _("Play First Second"), _("Play the first second of the subtitle currently selected")),
        ...
        action_group->add(Gtk::Action::create(
                              "video-player/play-next-second", _("Play Next Second"), _("Play the second following the subtitle currently selected")),
