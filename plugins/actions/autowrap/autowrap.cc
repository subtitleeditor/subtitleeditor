...
class AutoWrapPlugin : public Action {
   public:
    ...
    void activate() {
        ...
        action_group->add(Gtk::Action::create("autowrap-wide",
                                              _("Wrap Text Wide"),
                                              _("Reflow the text of selected subtitles fitting as many words on each line as possible while "
                                                "respecting the maximum characters per line setting")),
   ...
   protected:
    ...
    static Glib::ustring::iterator
    Iter_find_first_of(Glib::ustring &text, Glib::ustring::iterator sit, Glib::ustring::iterator eit, Glib::ustring what) {
