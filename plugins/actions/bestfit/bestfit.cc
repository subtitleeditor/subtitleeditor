...
class BestFitPlugin : public Action {
   public:
    ...
    void activate() {
        ...
        action_group->add(Gtk::Action::create("best-fit",
                                              _("_Best Fit Subtitles"),
                                              _("Equalize the speed (in CPS) of the selected subtitles between the start of the first and the end of "
                                                "the last (while respecting the minimum gap between subtitles and their minima duration)")),
